...
class TestSpider(scrapy.Spider, ABC):
    ...
    def parse_detail(self, response):
        title = ''.join(
            response.xpath('//*[@id="wrapper"]/div[4]/div/div[2]/table/tbody/tr[3]/td[2]//text()').extract())
        pubdate = ''.join(
            response.xpath('//*[@id="wrapper"]/div[4]/div/div[2]/table/tbody/tr[3]/td[4]//text()').extract()).replace(
            ' ', '')
